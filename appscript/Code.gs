...
const GUIDE_SYSTEM_PROMPT = [
  ...
  '- PART 2: input.industry 값에서 업종 코드(예: "C18", "ETC")와 안내문구(예: " / 지원 기준: 매출 2억원 미만")는 잡음이므로 모두 무시하고, 실제 업종명 부분만 추출해 자연스러운 한국어로 풀어 사용 (예: "C18 인쇄 및 기록매체 복제업 / 지원 기준: 매출 2억원 미만" → "인쇄·기록매체 복제업"). 추출한 업종을 바탕으로 어떤 제품을 누구에게 어떻게 만드는지 구체적으로 묘사하고 공정의 흐름을 한두 마디로 시각적으로 보여주기.',
  ...
  '- 업종 코드(예: "C18", "ETC")와 지원 기준 안내문구(예: "/ 지원 기준: 매출 2억원 미만") 노출 금지',
...
const GUIDE_FEWSHOT_INPUT = {
  company: '성진정밀가공',
  ceo: '김성진',
  industry: 'C25 금속가공제품 제조업 / 지원 기준: 매출 2억원 미만',
...
function testGuidePrompt() {
  ...
  const SAMPLE_CASES = {
    ...
    case_haerang_인쇄: {
      company: '해랑',
      ceo: '이한솔',
      industry: '그 외 업종 / 지원 기준: 매출 2억원 미만',
      equipment: 'JU1810+',
      problemProcess: '인쇄공정',
